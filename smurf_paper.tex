...
reduction of smaller data sets in a reasonable amount of time. While
maximum likelihood maps are, theoretically, the best maps that can be
made from a noise point of view, the required computing resources and
execution time would not have been feasible for the proposed real-time
data reduction and data archiving model.
