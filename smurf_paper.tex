...
reducing \scuba\ data is to model (and remove) noise sources, and to
iterate this process along with estimates of the map. This sort of
...
framework with a simple (though extensive) interface for user
configurability. Though written in C, \smurf\ uses an object-oriented
