...
\caption{Illustration of the dominance of atmospheric variations on
  ...
  on 20110324. Red and blue lines show the 850 and 450\,\micron\
...
from observation 18 on 20110324, during highly variable weather
...
range $\sim$0.1--1.0\,Hz is usually employed remove this residual
noise (Section~\ref{sec:components}), which will also remove any sky
...
during map-making beyond the $\sim$70\% detector yield.  As an
...
insignificant). The approach we have taken to minimise systematics is
