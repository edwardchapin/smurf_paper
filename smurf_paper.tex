...
\subsubsection{Experimental models for the removal of magnetic field pickup and the atmosphere}
...
squids do not work for every column (several in each subarray),
...
working detectors that are not detecting in the dark
