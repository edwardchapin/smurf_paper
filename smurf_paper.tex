...
have a C interface. It was therefore decided to develop SMURF in C
(rather than C++ which would have required adding further dependencies
to Starlink), although we have taken an object-oriented approach. For
example, all of the data for a given noise model is stored in a C
structure, and there is a standard interface for all functions that
