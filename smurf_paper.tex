...
is said to be ``white noise limited'', meaning that the map noise is
uncorrelated spatially, and has an amplitude that scales as the
...
reducing bolomter data in the literature. The simplest methods involve
some basic processing of the data to remove as much noise
contamination as possible, e.g., using baseline removal, filters, and
then simply re-gridding the data into a map. Such was the basic recipe
for the baseline reduction of chopped data from SCUBA-2's predecessor
SCUBA (reference?), and MAMBO, another camera from the same
