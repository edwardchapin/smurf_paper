...
The main problem with the iterative solution is divergence on large
...
signal above some \snr\ threshold) provides good constraints for
compact objects, and bright/extended structures, allowing us to
...
likely be a maximum-likelihood algorithm, such as SANEPIC
...
and Engineering Research Council of Canada. We thank Mark Halpern,
Matthew Hasselfield, and Gaelen Marsden for many useful discussions.
The authors thank the members of the SCUBA-2 commissioning team for
testing the map-maker and reporting anomalies; in particular Antonio
Chrysostomou, Jessica Dempsey, and Wayne Holland. We acknowledge the
...
panel. Finally, we thank Per Friberg and Gary Davis for their helpful
