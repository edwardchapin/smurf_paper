...
CADC \scuba\ raw-data queries page for the dates and observation
...
Fig.~\ref{fig:steps1} show examples of such steps in the time streams
...
addition, each end of the time stream is padded with double this
...
individual bad blocks to be rejected from a bolometer time stream,
